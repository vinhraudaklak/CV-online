...
export default function Wizard(props) {
	...
	// Set chuyển động vật theo trục y theo chu kỳ.
	const modelRef = useRef();
	useFrame((state, delta, xrFrame) => {
		// Math.sin(x) → Trả về giá trị dao động từ -1 đến 1 dựa trên x (theo hàm sin). 	
		// state.clock.elapsedTime → Thời gian đã trôi qua kể từ khi ứng dụng bắt đầu (tính bằng giây).
		// Dùng để tạo chuyển động mượt mà, lặp lại theo chu kỳ (animation).
	...
	return (
		<group
			...
			dispose={null}
			ref={modelRef}
			// Set position and scale, rotation 3D.
			position={[0.2, -1.5, 0]}
